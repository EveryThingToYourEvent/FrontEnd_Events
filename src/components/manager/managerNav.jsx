    ...
    <nav className="navbar navbar-expand-sm navbar-dark bg-dark sticky-top">
        <div className="container-fluid" id="myNav">
            ...
            <div className="collapse navbar-collapse" id="mynavbar">
                <NavLink className="myLink" to={'managementProvider'}>ספקים</NavLink>
                <NavLink className="myLink" to={'providersList'}>ספקים שאושרו</NavLink>
                <NavLink className="myLink" to={'categoiriesList'}>מחלקות</NavLink>
                <NavLink className="myLink" to={'eventTypeList'}>סוגי אירוע</NavLink>
